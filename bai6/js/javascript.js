function DangKyThanhVien()
{
	...
	if(kq==true)
		document.getElementById("ketqua").innerHTML="Đã xác nhận thông tin";
	else
		document.getElementById("ketqua").innerHTML="Vui lòng nhập lại thông tin";
	return kq;
}

function changeImage(key)
{
	document.getElementById("imglarge").src="../images/galaxy_s8/"+ document.getElementById(key).name;
}
function changeColor(key)
{
	document.getElementById("imgSmall1").src= "../images/galaxy_s8/"+key + "_1.jpg";
	document.getElementById("imgSmall2").src= "../images/galaxy_s8/"+key + "_2.jpg";
	document.getElementById("imgSmall3").src= "../images/galaxy_s8/"+key + "_3.jpg";
	document.getElementById("imgSmall4").src= "../images/galaxy_s8/"+key + "_4.jpg";
	document.getElementById("imgSmall5").src= "../images/galaxy_s8/"+key + "_5.jpg";
	...
	document.getElementById("imglarge").src="../images/galaxy_s8/"+ key + "_1.jpg"
}	